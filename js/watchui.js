...
(function() {
    ...
    window.WatchApp = function(params) {
        ...
        app.version = "2.1 (1503300145)"
    };

    window.WatchCore = function(params) {
        var core = this;

        core.version = "1.1 (1503300155)";
        ...
        core.home = function(appClosingTimeout) {
            ...
            setTimeout(function() {
                ...
                core.watchUI.iconMapRefresh(100, core.watchUI.params.iconSize, {
                    x : 0,
                    y: 0
                });
                ...
                setTimeout(function() {
                    ...
                    core.params.screenContainer.on("touchstart mousedown", function(e) {
                        ...
                        $(window).on('touchmove mousemove', function(e) {
                            ...
                            core.watchUI.iconMapRefresh(100, core.watchUI.params.iconSize, {
                                x : core.watchUI.params.scrollX,
                                y: core.watchUI.params.scrollY
                            })
                        });
    ...
    window.WatchUI = function(params) {
        ...
        ui.init();
        ui.iconMapRefresh(100, ui.iconSize, {
            x : 0,
            y: 0
        });
    };
